...
export default function NavBar() {
  ...
  return (
    <>
      ...
      >
        <div className={cn('h-16 max-w-5xl w-full flex items-center justify-between px-4 lg:px-0')}>
          {/* 로고 */}
          <Link
            href="/"
            className="flex items-center gap-2 font-bold font-shrik text-xl md:text-2xl tracking-wider"
          >
            yuniverse
          </Link>
        ...
        >
          {isOpen ? (
            <RiCloseLargeLine className="size-full" />
          ) : (
