    ...
    programs: [
      {
        description:
          ...
          "- Axios와 커스텀 훅을 활용한 데이터 통신 로직 설계\n" +
          "- React Router를 사용해 페이지 간 라우팅 구현\n" +
        ...
        {ProjectData.map((project, index) => (
          <SimpleBox key={index}>
            ...
            <div className="flex flex-col md:flex-row items-start w-full md:space-x-4">
              <h2 className="text-lg font-bold mb-2 md:w-1/5">{project.title}</h2>
              <div className="flex flex-col w-full md:w-4/5 space-y-2">
                {project.programs.map((program, programIndex) => (
